...
{{--</li>--}}
{{--<li>--}}
{{--    <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.member.posts.create') }}" title="{{ trans('plugins/blog::member.write_post') }}">--}}
